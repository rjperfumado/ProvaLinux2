...
public class Principal {
	...
	private void execute() throws IOException {
		...
		email.enviarMensagem("javaicesp@gmail.com", "Alunos e Filmes", pilhaFilmes, pilhaAlunos,pilhalivros);//chama o método de enviar e-mail
		escreveArquivo.escrever(pilhaFilmes, pilhaAlunos,pilhalivros, "novoArquivoGerado.txt", "Livros e Filmes"); //chama o método de escrever o arquivo
	}
